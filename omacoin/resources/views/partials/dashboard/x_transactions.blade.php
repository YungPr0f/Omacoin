                            ...
                            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <td>
                                    <div class="light-rounded-buttons info-buttons">
                                        <a href="#" data-toggle="modal" data-target="#receiptModal{{ $transaction->id }}" class="main-btn info-two xs-btn text-none font-weight-normal w-100 d-flex align-items-center justify-content-center">
                                            <i class="lni-search mr-2"></i>    
                                            Review Receipt
                                        </a>
                                    </div>

                                    <!-- Review Receipt Modal - Processing Payment -->
                                    <div class="modal fade receiptModal" id="receiptModal{{ $transaction->id }}" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content d-block">
                                                ...
                                                <div class="modal-body" style="max-height:332px;">
                                                    <strong>${{ $transaction->crypto_amount }}  {{ $currencies[$transaction->wallet_currency]['name'] }}</strong> was sent into <strong>{{ $transaction->wallet_platform . ' ' . $transaction->wallet_currency }}</strong> wallet address: <u>{{ $transaction->wallet_address }}</u>
                                                        ...
                                                        <div class="sign-in-form-wrapper form-style-two no-icon">
                                                            <div class="form-input mt-4">
                                                                <label class="d-flex justify-content-between">
                                                                    <span class="d-flex align-items-end">Proof of Payment</span>
                                                                ...
                                                                <div class="input-items default receipt-preview hidden" data-value="">
                                                                    <img src="{{ asset('img/receipts/' . $transaction->crypto_receipt) }}" alt="" class="img-fluid w-100 field-border">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <td>
                                    <div class="light-rounded-buttons light-rounded-buttons">
                                        <a href="#" data-toggle="modal" data-target="#nairaWaitModal{{ $usertransaction->id }}" class="main-btn light-rounded-two xs-btn text-none font-weight-normal w-100 d-flex align-items-center justify-content-center">
                                            ...
                                            @php
                                                $created = strtotime($usertransaction->created_at);
                                                $expired = strtotime('+1 hour', $created);
                                                $time_left = $expired - time();
                                            @endphp
                                            Please wait ...&nbsp;<span class="countdown-timer" data-hh="" data-mm="" data-ss="{{ $time_left }}">00:00</span>
                                        </a>
