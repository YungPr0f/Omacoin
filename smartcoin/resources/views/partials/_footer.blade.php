                        ...
                        <div class="col-6">
                            <div class="footer-logo-support d-md-flex align-items-end justify-content-between">
                                <div class="footer-logo d-flex align-items-end">
                                    <a class="mt-30" href="index.html"><img src="{{ asset('img/logo/SmartCoin.png') }}" class="img-fluid" alt="Logo"></a>
                            ...
                            <span class="mail">support@smartcoin.com.ng</span> -->
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright text-center">
                        <p class="text text-white">Copyright © 2021 SmartCoin. All Rights Reserved</p>
                    </div>
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
